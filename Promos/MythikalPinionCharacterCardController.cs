...
{
	public class MythikalPinionCharacterCardController : HeroCharacterCardController
	{
		public MythikalPinionCharacterCardController(
			Card card,
		...
		) : base(card, turnTakerController)
		{
			...
			SpecialStringMaker.ShowSpecialString(() => String.Format(
				"Pinion has {0} {1} and {2} {3} control tokens.",
